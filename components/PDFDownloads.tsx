  ...
  return (
    <section className="section bg-neutral-50">
      <div className="container-custom">
        ...
        <div className={`${downloads.length === 1 ? 'flex justify-center' : 'grid md:grid-cols-2 gap-8 max-w-4xl mx-auto'}`}>
          {Object.entries(groupedDownloads).map(([category, categoryDownloads]) => (
            <div key={category} className={`space-y-4 ${downloads.length === 1 ? 'max-w-md' : ''}`}>
              <h3 className="text-xl font-semibold text-discovery-charcoal mb-4 flex items-center justify-center gap-2">
